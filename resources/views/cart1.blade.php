        ...
        <div class="flex flex-col md:flex-row shadow-md my-10">
            <div class="md:w-3/4 bg-white px-4 md:px-10 py-6 md:py-10">
                <div class="flex justify-between border-b pb-4 md:pb-8">
                    ...
                    <h2 class="font-semibold text-xl md:text-2xl"> Total Products({{ count($cartItems) }}) </h2>
                </div>
                        ...
                        @else
                            @foreach ($cartItems as $cartItem)
                                <div class="flex items-center hover:bg-gray-100 -mx-2 md:mx-0 px-4 md:px-6 py-3 md:py-5 ">
                                    <div class="flex w-2/5 ">
                                        ...
                                        <div class="flex flex-col justify-between ml-3 md:ml-4 flex-grow s">
                                            ...
                                            <Link
                                                href="{{ route('deleteSessionCart', ['cart' => $cartItem['product_id']]) }}"
                                                method="DELETE"
                                ...
                                quantity" :default="['quantity' => $cartItem['quantity']]"
                                            action="{{ route('updateSessionCart', ['cart' => $cartItem['product_id']]) }}"
                                            method="PUT" class=" " @success="$splade.emit('quantity_updated')">
                                            <div
                                ...
                                sm:space-x-4">
                                    ...
                                    <span style="margin-right:3%" class="text-center w-1/5 font-semibold text-xs md:text-sm"
                ...
                <div class="mt-6 md:mt-10 mb-5">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="w-1/4">
                            @if (count($cartItems) < 1)
                                <button
                                    class="w-full bg-buttonColor0 text-white font-semibold py-2 rounded-md hover:bg-buttonColor1 focus:outline-none">
                                    APPLY</button>
                            @else
            ...
            <div id="summary" class="w-full md:w-1/4 px-4 md:px-8 py-6 md:py-10">
                ...
                <div class="mt-6 md:mt-10">
                    @if (count($cartItems) < 1)
                        <Link href="#">
                        <button
                            class=" disabled w-full bg-buttonColor0 hover:bg-buttonColor1 text-white font-semibold py-2 rounded-md text-xs md:text-sm focus:outline-none mt-4">CHECKOUT</button>
                        </Link>
                    @else
                        <Link href="{{ 'checkout' }}">
                        <button
